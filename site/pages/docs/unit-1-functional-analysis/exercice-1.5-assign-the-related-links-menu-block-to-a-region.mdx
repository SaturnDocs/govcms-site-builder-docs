---
title: "Exercise 1.5: Assign the related links menu block to a region"
---
...
2.  Scroll down and find the **Footer middle 2** area and click the **Place block** button.
    ...
    <Frame caption="Place block in the Footer middle 2 region"><img src="/img/image-7.png" alt="" /></Frame>
3. Search the list for - _Related Links_. Select Menus block “Related Links”.
4.  Click **Place block**.



    <Frame><img src="/img/Ex-1-5-Assign-Related-Links-2.png" alt="" /></Frame>
...
8.  Check your site to make sure the **Related Links** menu block is in the **Footer**.\
    ...
    <Frame caption="Related Links block in the Footer"><img src="/img/image-9.png" alt="" /></Frame>
