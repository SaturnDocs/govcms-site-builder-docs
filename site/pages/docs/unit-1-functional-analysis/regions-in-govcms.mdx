...
![Image of Block layout](/img/Unit-1-Regions-Block-layout-1.png)

Once at this page, click on the **Demonstrate block regions \(Olivero\)** button.

![Image of Demonstrate block regions](/img/Unit-1-Regions-Block-layout-2.png)
