---
title: "Exercise 1.6: Configure the related links menu block"
---
...
![Image of Block Visibility settings](/img/Ex-1-6-Configure-Related-Links-1.png)

The **Related Links** menu will only be displayed on the front and About us pages.

![Image of Block Visibility settings](/img/Ex-1-6-Configure-Related-Links-2.png)
