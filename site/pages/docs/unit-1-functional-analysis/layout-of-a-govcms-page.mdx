...
![Image of page Regions](/img/5.png)
...
![Image of page regions and Content blocks](/img/6.png)

You may explore the default theme GitHub repository to review the available regions: [https://github.com/govCMS/govcms8_uikit_starter/blob/8.x-1.x/govcms8_uikit_starter.info.yml#L8](https://github.com/govCMS/govcms8_uikit_starter/blob/8.x-1.x/govcms8_uikit_starter.info.yml#L8)
