---
title: "Exercise 1.3: Place Welcome message block"
---
...
<Frame caption="Showing Blocks in the various footer regions"><img src="/img/image-5.png" alt="" /></Frame>
...
<Frame caption="Entering data into the block creation page"><img src="/img/image-1-1-1.png" alt="" /></Frame>
...
![Block configuration page](/img/Ex-1-3-Add-custom-block-2.png)
...
![Block configuration page](/img/Ex-1-3-Add-custom-block-3.png)
...
<Frame caption="New block being seeing in the Footer top 1 region"><img src="/img/image-2-1.png" alt="" /></Frame>
