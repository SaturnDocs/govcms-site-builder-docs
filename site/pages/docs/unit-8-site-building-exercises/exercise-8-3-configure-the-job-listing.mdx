---
title: "Exercise 8.3: Configure the job listing"
---
...
![Image of Jobs posting View](/img/Ex-8-3-Job-Listing-View-1.png)

If you don’t have the job listing view, we’ll create it and set the filter criteria.

![Image of View settings](/img/Ex-8-3-Job-Listing-View-2.png)
...
![Image of Filter criteria](/img/Ex-8-3-Job-Listing-View-3.png)
...
![Image of Job listing page with filter](/img/Ex-8-3-Job-Listing-View-4.png)
...
![Image of Views relationships](/img/Ex-8-3-Job-Listing-View-5.png)
