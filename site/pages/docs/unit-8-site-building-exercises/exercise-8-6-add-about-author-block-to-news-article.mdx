---
title: "Exercise 8.6: Add About author block to News article"
---
...
2.  Add an Image field, using your previous experience adding fields. Make the Image field match the following criteria:
    ...
    * **Machine name**: field\_profile\_image
    ...
    <img src="/img/Ex-8-6-About-Author-3.png" alt="Image of New field settings" />
    ...
    * **Allowed number of values:** 1
    ...
    <img src="/img/Ex-8-6-About-Author-4.png" alt="Image of New field settings" />
    ...
    * **Maximum upload size:** 1MB
    ...
    <img src="/img/Ex-8-6-About-Author-5.png" alt="Image of Field settings" />
3.  Configure **Manage Display**:
    ...
    <img src="/img/Ex-8-6-About-Author-6.png" alt="Image of Field settings" />
4. **Save** your changes.
...
![Image of Authoring information](/img/Ex-8-6-About-Author-7.png)
...
2.  Use the following information to fill out the form:
    ...
    * Change **Items per block** to 1. Use the defaults for everything else (ensure the settings are as shown in the image below)
    ...
    <img src="/img/Ex-8-6-About-Author-8.png" alt="Image of View create page" />
...
![Image of full Views editing screen](/img/Ex-8-6-About-Author-9.png)
...
4.  Select _Specify validation criteria_ under **“When the filter value IS available or a default is provided”** and select **User ID** as **Validator**.
    ...
    <img src="/img/Ex-8-6-About-Author-10.png" alt="Image of Provide default value" />
5. Click **Apply**.
...
![Image of News and media Manage display](/img/Ex-8.6-About-Author-11.png)
