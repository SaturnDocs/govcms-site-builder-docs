---
title: "Exercise 8.2: Create Agency References"
---
...
![Image of ATO site](/img/Ex-8-2-ATO-site.png)
...
![Image of Agency logo config settings](/img/Ex-8-2-Agency-1.png)
...
![Image of Agency logo config settings](/img/Ex-8-2-Agency-Logo-2.png)
...
![Image of Agency logo config settings](/img/Ex-8-2-Agency-Logo-3.png)
...
![Image of Agency logo config settings](/img/Ex-8-2-Agency-Logo-4.png)
...
2.  Add a new field using these settings:
    ...
    * **Sort by**: - None -
    ...
    <Frame><img src="/img/Ex-8-2-Agency-Logo-5.png" alt="" /></Frame>
...
6.  Your job posting fields will now look something like the screenshot below.
    ...
    <Frame><img src="/img/Ex-8-2-Agency-Logo-6.png" alt="" /></Frame>
7. You may rearrange any new fields we’ve added and bring them above the Job description field.

![Image of Manage form display](/img/Ex-8-2-Agency-Logo-7.png)

![Image of Manage display](/img/Ex-8-2-Agency-Logo-8.png)
