---
title: "Exercise 8.7: Set up profile fields"
---
...
![Image of User profile with image](/img/Ex-8-7-User-Profile-Fields-1.png)
...
6.  Go to the **Manage form display** tab and set the **Widget** for About me to: _Text area (multiple rows)_.
    ...
    <img src="/img/Ex-8-7-User-Profile-Fields-2.png" alt="Image of User profile with image" />
...
6.  **Add** a new field:
    ...
    * **Vocabulary**: Interests
    ...
    <img src="/img/Ex-8-7-User-Profile-Fields-3.png" alt="Image of User profile with image" />
...
1.  Click **Your username** in the top administration menu, then _View profile_, then the **Edit profile** tab.
    ...
    <img src="/img/Ex-8-7-User-Profile-Fields-4.png" alt="Image of Edit profile page" />
