---
title: "Review configuration of image media display"
---
...
![The Advanced configuration of the Image field uses &#x201C;Image styles&#x201D; in most cases](/img/Unit-3-Image-Display-Config.png)
