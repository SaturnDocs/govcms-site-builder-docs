---
title: "Exercise 3.1: Example use of image styles"
---
...
| -------------------------------------------------------------- | ----------------------------------------------------------------- |
| ![Image of Thumbnail display](/img/57-1.png) | ![Image of Full content display](/img/58-2.png) |
...
![Image of image display](/img/Ex-3-1-Image-Style-3.png)
