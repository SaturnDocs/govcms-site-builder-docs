---
title: "Content listing with Views"
---
...
![A screenshot of Views UI - a way to create content listing in GovCMS](/img/Unit-6-Views-1.png)
...
![A screenshot of create View interface](/img/Unit-6-Views-2.png)
