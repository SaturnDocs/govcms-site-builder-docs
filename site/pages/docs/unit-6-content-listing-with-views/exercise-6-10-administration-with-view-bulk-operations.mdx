---
title: "Exercise 6.10: Administration with View bulk operations"
---
...
1.  Go to _Configuration_ → _Workflow_ → **Workflows**.
    ...
    <Frame><img src="/img/Ex-6-10-Workflows-1.png" alt="" /></Frame>
...
3.  Scroll down to **This workflow applies to** section and press **Select** in the **Content types** row.
    ...
    <Frame caption="Select button next to Content types in Workflow"><img src="/img/image-39.png" alt="" /></Frame>
4.  Select the **Job Posting** checkbox, **Save** the changes.

    <Frame caption="Select Job Post"><img src="/img/image-40.png" alt="" /></Frame>
...
1.  Create a new View with the following settings:
 ...
 | Create a block | No |
    ...
    <Frame><img src="/img/Ex-6-10-Workflows-4.png" alt="" /></Frame>
...
2.  Configure the **Bulk operations**: Available actions:
    ...
    * Update URL alias
    ...
    <Frame><img src="/img/Ex-6-10-Workflows-5.png" alt="" /></Frame>

    <Frame><img src="/img/Ex-6-10-Workflows-6.png" alt="" /></Frame>
...
![Image of View](/img/Ex-6-10-Workflows-7.png)
...
![Image of Rearrange fields](/img/Ex-6-10-Workflows-8.png)

![Image of Rearrange fields](/img/Ex-6-10-Workflows-9.png)

## Remove unnecessary filters

The filter **Content: Published (= Yes)** can be removed as we will be replacing it in the next section.

![Image of Remove unnecessary filters](/img/Ex-6-10-Workflows-10.png)

![Image of Remove unnecessary filters](/img/Ex-6-10-Workflows-11.png)
...
![Image of Add moderation workflow filter](/img/Ex-6-10-Workflows-13.png)

> **Tip:** Hold down the Command key (Control for Windows) to select multiple options.

## Configure the format settings

![Image of Configure the format settings](/img/Ex-6-10-Workflows-14.png)
...
![Image of Edit sortable settings](/img/Ex-6-10-Workflows-15.png)
...
2.  Select Global: Text area
    ...
    <Frame><img src="/img/Ex-6-10-Workflows-16.png" alt="" /></Frame>
3.  Then set the message “There are no job postings currently waiting for review!”.



    <Frame><img src="/img/Ex-6-10-Workflows-17.png" alt="" /></Frame>
4. **Apply** the changes.
...
![Image of View - Access](/img/Ex-6-10-Workflows-18.png)

![Image of Change access settings](/img/Ex-6-10-Workflows-19.png)
...
![Image of No jobs waiting for review](/img/Ex-6-10-Workflows-20.png)
