...
![Image of Page Display and Block content views displays](/img/96-1.png)
...
![Image of GovCMS Block Article View](/img/Unit-6-Blog-Views-1.png)
...
![Image of Views pre-built templates](/img/Unit-6-Blog-Views-2.png)

![Image of Views pre-built templates](/img/Unit-6-Blog-Views-3.png)

## The Views editing interface – Format pane

In this section we’re going to look at the Views editing interface.

![Image of Views editing interface](/img/Unit-6-Blog-Views-4.png)
