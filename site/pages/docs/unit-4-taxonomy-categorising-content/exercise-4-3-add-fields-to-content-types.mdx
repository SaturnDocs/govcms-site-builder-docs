---
title: "Exercise 4.3: Add fields to content types"
---
...
2.  Click on **Manage fields** to the right of the _Job posting_ content type name.
    ...
    <img src="/img/Ex-4-3-Add-Fields-1.png" alt="Image of add field to content type" />
...
![Image of add field to content type](/img/Ex-4-3-Add-Fields-2.png)
...
![Image of add field to content type](/img/Ex-4-3-Add-Fields-3.png)
