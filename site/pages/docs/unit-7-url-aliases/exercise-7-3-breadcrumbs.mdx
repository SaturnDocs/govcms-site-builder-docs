---
title: "Exercise 7.3: Breadcrumbs"
---
...
In Unit 6 we created a View called _Job Posting_ and added a link to the top Main Navigation menu (Exercise 6.2).

![Image of Job posting View](/img/Ex-7-3-Breadcrumbs-1.png)
...
![Image of Breadcrumb to Home](/img/Ex-7-3-Breadcrumbs-2.png)
...
![Image of Breadcrumb to Jobs page](/img/Ex-7-3-Breadcrumbs-3.png)
...
2.  Locate _Path_ under _Page Settings_ (middle top section).
    ...
    <Frame><img src="/img/Ex-7-3-Breadcrumbs-4.png" alt="" /></Frame>
...
![Image of Breadcrumb to Jobs page](/img/Ex-7-3-Breadcrumbs-5.png)
