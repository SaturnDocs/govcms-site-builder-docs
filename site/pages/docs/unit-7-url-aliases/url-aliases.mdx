...
![Image of Custom URL alias](/img/Unit-7-URL-Aliases-1.png)

If you use the content's menu settings to add this to the Main menu, the link will be updated automatically:

![Image of Menu settings](/img/Unit-7-URL-Aliases-2.png)

![Image of Menu link to alias](/img/Unit-7-URL-Aliases-3.png)
...
![Image of Blog article Pattern settings](/img/Unit-7-URL-Aliases-4.png)
