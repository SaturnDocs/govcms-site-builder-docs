---
title: "Exercise 2.6: Add a custom text field"
---
...
2.  Click **+ Add field**.
    ...
    <img src="/img/Ex-2-6-Add-Field-1.png" alt="Image of add Field" />
3.  Under **Text**, select _List (text)_.
    ...
    * Click **Save and continue**.
    ...
    <img src="/img/Ex-2-6-Add-Field-2.png" alt="Image of add Field" />
...
![Image of auto suggested field name](/img/Ex-2-6-Add-Field-3.png)
...
1.  Add the following options to the **Allowed Values list** text area:
    ...
    * 4|Full-time
    ...
    <img src="/img/Ex-2-6-Add-Field-4.png" alt="Image of allowed values list" />
...
![Image of Manage Form display](/img/Ex-2-6-Add-Field-5.png)
...
![Image of Manage Form display](/img/Ex-2-6-Add-Field-6.png)
