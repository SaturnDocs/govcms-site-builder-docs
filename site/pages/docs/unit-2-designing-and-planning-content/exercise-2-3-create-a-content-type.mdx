---
title: "Exercise 2.3: Create a content type"
---
...
[https://www.drupal.org/docs/user_guide/en/structure-content-type.html](https://www.drupal.org/docs/user_guide/en/structure-content-type.html)
...
| -------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| ![Image of Job posting form](/img/Ex-2-3-Add-Content-Type-0-1.png) | ![Image of job Posting](/img/Ex-2-3-Add-Content-Type-0-2.png) |
...
4.  We want jobs to be published by default, but not automatically promoted to the front page, so under **Publishing options** use these settings:
    ...
    * **Create new revision**: Leave selected.
    ...
    <img src="/img/Ex-2-3-Add-Content-Type-1.png" alt="Image of Add content type" />
...
![Image of Jobs content type fields](/img/Ex-2-3-Add-Content-Type-2.png)
