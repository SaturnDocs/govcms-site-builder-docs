---
title: "Exercise 9.3: Create new search page with Search API"
---
...
![Image of Create Index](/img/Ex-9-3-Search-API-2.png)

![Image of Create Index](/img/Ex-9-3-Search-API-3.png)
