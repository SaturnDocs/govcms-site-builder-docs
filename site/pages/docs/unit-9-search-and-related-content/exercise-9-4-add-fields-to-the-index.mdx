---
title: "Exercise 9.4: Add fields to the index"
---
...
![Image of Add fields to Search index](/img/Ex-9-4-Search-Fields-1.png)

![Image of Edit field Rendered HTML output](/img/Ex-9-4-Search-Fields-2.png)
...
![Image of Edit field Rendered HTML output](/img/Ex-9-4-Search-Fields-3.png)
...
1.  Click the View tab at the top
    ...
    <img src="/img/Ex-9-4-Search-Fields-4.png" alt="Image of Index now" />
...
3.  Search for **“Fulltext search”** from the Search category.
    ...
    <img src="/img/Ex-9-4-Search-Fields-5.png" alt="Image of contextual link" />
4. Click **Add and configure the filter.**
5. Toggle on - **Expose this filter to visitors, to allow them to change it**.
6.  **Label:** empty

    <img src="/img/Ex-9-4-Search-Fields-6.png" alt="Image of contextual link" />
7. **Apply** the changes and **Save** the view.
8. Test it out.

![Image of contextual link](/img/Ex-9-4-Search-Fields-7.png)
