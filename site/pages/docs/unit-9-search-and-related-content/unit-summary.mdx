...
For more information on how Search API module and Apache Solr work go to [https://www.drupal.org/docs/8/modules/search-api-solr](https://www.drupal.org/docs/8/modules/search-api-solr)
